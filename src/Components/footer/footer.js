        ...
        <>
            ...
            <div className="container-fluid bgcolor text-white  " id="footer">
                <div className="row">
                    ...
                    {/* <div className="col-lg-3 me-3 mt-4 pt-5 ">
                        <p><b>Contact Details</b></p>
                        <a href="tel:9363466093"><FontAwesomeIcon icon={faPhone} className="hoverani text-white"></FontAwesomeIcon></a> <span className="ms-2">9363466093</span><br/>
                        <a href="mailto:info@kggeniuslabs.com"><FontAwesomeIcon icon={faEnvelope} className="hoverani text-white"></FontAwesomeIcon></a><span className="ms-2"> info@kggeniuslabs.com</span>
                        <p className=""><b>Social Media</b></p>
